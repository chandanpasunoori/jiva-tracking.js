...
var Jiva = require('../../../lib/index');
var config = require('../helpers/client-config');

// Jiva.debug = true;

describe('Jiva (browser)', function() {
  ...
  describe('client defaults', function() {
    ...
    it('should have sensible values', function(){
      assert.equal(this.client.config.host, 'api.jiva.io');
  ...
  describe('.resources()', function(){
    ...
    it('should return the current resources object', function(){
      assert.deepEqual(this.client.resources(), Jiva.resources);
    });
