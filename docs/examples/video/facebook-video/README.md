...
This example demonstrates how to instrument the [Facebook video player](https://developers.facebook.com/docs/plugins/embedded-video-player/api#control-reference) to capture usage stats with Jiva IO.
