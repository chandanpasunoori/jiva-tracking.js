...
This example demonstrates how to instrument the [Youtube iFrame video player](https://developers.google.com/youtube/iframe_api_reference) to capture usage stats with Jiva IO.
