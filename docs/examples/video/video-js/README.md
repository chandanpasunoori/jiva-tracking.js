...
This example demonstrates how to instrument the [Video.js player](https://docs.videojs.com/) to capture usage stats with Jiva IO.
...
<body>
  ...
  */
  videojs.plugin('recordJivaEvents', function(client){
